...
def main():
    ...
    Example (PASS):
        ...
        python Tester.py -c 10 -m 5 -n 201234,5000,1000,50000,1,2000,30000,40000,500000,20000 -M bradfitz,abcdef,jklfdsafs,jrieonfk,lsjin,adfa,fdafdsa,dfs,fddsf,dfdsf
    """
    compile_programs()
